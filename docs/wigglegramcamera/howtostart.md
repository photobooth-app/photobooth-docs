...
2. Build the Camera Array
    ...
    3. [Install](./installation.md) the [nodes' software](https://github.com/photobooth-app/wigglecam). Each device is a separate computer and setup separately. Ansible comes to the rescue to simplify this task.
    4. [Setup the nodes in the photobooth-app](./setup.md). Integrate the nodes with the app and calibrate the camera array to achieve smooth results.
