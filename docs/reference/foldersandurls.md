...
The unprocessed version represents the original without any filter or pipeline stages from postprocessing applied.
The processed version has all configured filters applied.
